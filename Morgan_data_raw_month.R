...
filter(day_trk, id == "X027_2012/12") %>% summarise(length = length(x_))
filter(day_trk, id == "X027_2013/01") %>% summarise(length = length(x_))
...
kde_shape_1 <- trk2 %>% filter(id == "X023_2013/06") %>%
  hr_kde(., levels = c(0.95))
kde_shape_2 <- trk2 %>% filter(id == "X023_2013/07") %>%
  hr_kde(., levels = c(0.95))
...
write.csv(data_summary, file = "summary/morgan_data_month_summary.csv", row.names = FALSE)
