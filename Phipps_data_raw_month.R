...
filter(day_trk, id == "AG032_2009/04") %>% summarise(length = length(x_))
filter(day_trk, id == "AG032_2009/05") %>% summarise(length = length(x_))
...
kde_shape_1 <- trk2 %>% filter(id == "AG032_2009/04") %>%
  hr_kde(., levels = c(0.95))
kde_shape_2 <- trk2 %>% filter(id == "AG032_2009/05") %>%
  hr_kde(., levels = c(0.95))
...
write.csv(data_summary, file = "summary/phipps_data_month_summary.csv", row.names = FALSE)
