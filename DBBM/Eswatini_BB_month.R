...
#' try one
st_area(hr_isopleths(dbbmm$ID1_2015.06, level = 0.95)) / 1e6 #' 6839.758 
st_area(hr_isopleths(dbbmm$ID1_2015.07, level = 0.95)) / 1e6 #' 23186.58 
...
#' test it here
intersection_1_95 <-
  st_intersection(hr_isopleths(dbbmm$ID1_2015.07, level = 0.95),
...
write.csv(export_data, file = "summary/brownian/eswatini_bb_month.csv")
