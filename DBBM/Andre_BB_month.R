...
#' try one
st_area(hr_isopleths(dbbmm$X170948_2018.01, level = 0.95)) / 1e6 #' 6839.758 
st_area(hr_isopleths(dbbmm$X170950_2017.07, level = 0.95)) / 1e6 #' 23186.58 
...
#' test it here
intersection_1_95 <-
  st_intersection(hr_isopleths(dbbmm$X170948_2018.01, level = 0.95),
...
write.csv(export_data, file = "summary/brownian/andre_bb_month.csv")
