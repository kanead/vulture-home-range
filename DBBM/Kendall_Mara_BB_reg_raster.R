...
####' load the data ----
trk1 <- read_csv("regularised/kendall_mara_albers_reg.csv", col_names = TRUE)
trk1
...
write.csv(export_data, file = "summary/brownian/kendall_mara_bb_reg_raster.csv", row.names = F)
