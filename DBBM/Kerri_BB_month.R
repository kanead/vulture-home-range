...
#' try one
st_area(hr_isopleths(dbbmm$AM233, level = 0.95)) / 1e6 #'  
...
#' test it here
intersection_1_95 <-
  st_intersection(hr_isopleths(dbbmm$AM233, level = 0.95),
...
write.csv(export_data, file = "summary/brownian/kerri_bb_month.csv")
