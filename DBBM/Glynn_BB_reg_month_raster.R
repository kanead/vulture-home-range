...
####' load the data ----
trk1 <- read_csv("regularised/glynn_albers_reg_month.csv", col_names = TRUE)
trk1
...
write.csv(export_data, file = "summary/brownian/glynn_bb_reg_month_raster.csv", row.names = F)
