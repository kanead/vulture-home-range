#' Kendall Tanz - identification of breeding sites
...
recursion_time$study <- "kendall_tanz"

recursion_time
write.csv(recursion_time, file = "summary/recursion_kendall_tanz.csv", row.names = FALSE)
