#' Kendall Mara - identification of breeding sites
...
recursion_time$study <- "kendall_mara"

recursion_time
write.csv(recursion_time, file = "summary/recursion_kendall_mara.csv", row.names = FALSE)
