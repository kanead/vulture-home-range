...
kde_shape_1 <- trk_albers %>% filter(id == "#109018692") %>%
  hr_kde(., levels = c(0.95))
kde_shape_2 <- trk_albers %>% filter(id == "#143101591") %>%
  hr_kde(., levels = c(0.95))
...
#' writeRaster(kde_shape_1$ud, "KDE_#109018692_95_reg.tif")
#' writeRaster(kde_shape_2$ud, "KDE_#143101591_95_reg.tif")

#####' export summary stats ----
#' combine the summary stats

data_summary <- read_csv("summary/kendall_tanz_data_summary.csv", col_names = T)
...
write.table(data_summary, "summary/kendall_tanz_data_summary.csv", sep = ",", row.names=F)

# this is the order of the ids

# "#109018692" "#143101591" "#143105321" "#199120029" "#199122250" "#199122325" "#199122380"
# "#199122468" "#199122811" "#199123650" "#333857508" "#333858076" "#333859976" "#500257812"
# "#500258079" "#500258312" "#500258393" "#500258444" "#500258728" "#568288912" "#568289030"
# "#568291342" "#568291496" "#568291554" "#623177320" "#623187113" "#649690680" "#834449829"
# "#834450834" "#834451702" "#884505256" "#884521368" "#891879926" "#891880470" "#891880569"
# "#891880747" "#891880810" "#891880839" "#891880878" "#933591809" "#933591935" "#959152099"